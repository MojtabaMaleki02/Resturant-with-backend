  ...
  return (
    <form className="form-horizontal w-3/4 mx-auto" onSubmit={login}>
      ...
      <div className="flex flex-col mt-8">
        <button
          className="text-center mt-4 border border-gray-700 bg-transparent hover:bg-gray-700 text-lg text-black bg-yellow-300 hover:bg-yellow-400 font-medium py-2 px-4 rounded focus:outline-none"
        >
          Login
        </button>
        <a
